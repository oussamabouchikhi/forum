        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.form.post('/api/v1/auth/login');
...
var mutations = (_mutations = {}, _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__["SAVE_TOKEN"], function (state, _ref) {
  var token = _ref.token,
      remember = _ref.remember;
  state.token = token; // token expires in 365 days if remeber_me is checked

  js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.set("tpken", token, {
    expires: remember ? 365 : null
  });
}), _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__["FETCH_USER_SUCCESS"], function (state, _ref2) {
  var user = _ref2.user;
...
var actions = {
  saveToken: function saveToken(_ref3, payload) {
    ...
    commit(_mutations_types__WEBPACK_IMPORTED_MODULE_3__["SAVE_TOKEN"], payload);
  },
...
/*!***********************************************!*\
  !*** ./resources/js/store/mutations_types.js ***!
  \***********************************************/
/*! exports provided: LOGOUT, SAVE_TOKEN, FETCH_USER, FETCH_USER_SUCCESS, FETCH_USER_FAILURE, UPDATE_USER */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
